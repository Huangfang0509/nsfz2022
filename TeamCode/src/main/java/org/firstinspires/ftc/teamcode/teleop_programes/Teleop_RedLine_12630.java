...
@TeleOp(name = "红色联盟手动", group = "DriveControl")
public class Teleop_RedLine_12630 extends OpMode {
...
//        }
        ...
        //---------------------Led--------------------
//        if(gamepad2.dpad_up){
//            robot.Led.setPattern(RevBlinkinLedDriver.BlinkinPattern.BEATS_PER_MINUTE_LAVA_PALETTE);
//
//        }else if(gamepad2.dpad_left){
//            robot.Led.setPattern(RevBlinkinLedDriver.BlinkinPattern.BLUE);
//
//        }else if(gamepad2.dpad_down){
//            robot.Led.setPattern(RevBlinkinLedDriver.BlinkinPattern.BREATH_RED);
