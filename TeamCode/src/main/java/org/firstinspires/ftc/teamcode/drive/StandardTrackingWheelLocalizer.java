...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 1.0047;
    public static double Y_MULTIPLIER = 1.0031;
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap) {
        ...
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "rightEncode"));
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "duckRotate"));
